...
The managed-environment API and durable operation contracts are implemented; final provisioning recovery integration and frontend output-choice controls remain later phases.
