...
The gate-evaluated dashboard was **172 / 457 overall verified (37.6%)** and **150 / 220 primary-GUI verified (68.2%)**; the current dashboard is **210 / 457 overall (46.0%)** and **188 / 220 primary GUI (85.5%)**, with 0 blocked cells and 6 unassessed overall cells. Neither set of broader denominators makes a systematic-completion claim.
