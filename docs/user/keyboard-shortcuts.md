...
| Shortcut | Action |
|---|---|
| Ctrl/Cmd+S | Save the root workflow, or apply the active nested workflow to its parent. |
| Ctrl/Cmd+Z | Undo the latest canvas change. |
| Ctrl/Cmd+Shift+Z | Redo the latest canvas change. |
