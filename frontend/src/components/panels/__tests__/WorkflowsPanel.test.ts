...
const workflows: WorkflowInfo[] = [
  {
    ...
    results_path: '/library/workflows/alpha_api/results',
  ...
  },
  {
    ...
    results_path: '/library/workflows/beta_api/results',
...
describe('WorkflowsPanel', () => {
    ...
    const duplicateWorkflows: WorkflowInfo[] = [
      {
        ...
        results_path: '/library/workflows/A/nuclei/results',
        last_modified: '2026-04-30T12:34:56Z',
      identity_generation: 0,
      },
      {
        ...
        results_path: '/library/workflows/B/nuclei/results',
        last_modified: '2026-05-01T08:00:00Z',
      identity_generation: 0,
      },
    ]
  ...
  it('keeps workflow toolbar actions targeted at a workflow inside a folder', async () => {
    const nestedWorkflow: WorkflowInfo = {
      ...
      results_path: '/library/workflows/Analysis Results/beta_api/results',
      last_modified: '2026-05-01T08:00:00Z',
      identity_generation: 0,
    }
  ...
  it('creates, renames, and deletes the selected folder from the toolbar', async () => {
    ...
    vi.mocked(api.patch).mockResolvedValueOnce({
      data: {
        ...
        results_path: '/library/workflows/Analysis/beta_api/results',
        last_modified: '2026-05-01T08:00:00Z',
      identity_generation: 0,
      },
    })
